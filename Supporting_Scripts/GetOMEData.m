...
try
    OMEData.ScaleT=double(omeMeta.getPlaneDeltaT(0,1).value)-double(omeMeta.getPlaneDeltaT(0,0).value);
catch
    % in case of only a single t-plane set to 1 s ...
        msg = 'Problem getting time-Scaling. Use Default = 1';
    warning(msg);
    OMEData.ScaleT = 1;
end
